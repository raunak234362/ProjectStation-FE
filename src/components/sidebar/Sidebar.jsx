...
const Sidebar = () => {
  ...
  const navItems = [
    { label: "Dashboard", to: "/dashboard", icon: <LayoutDashboard />, roles: ["admin", "department-manager","project-manager", "client", "user", "estimator", "sales", "estimator-head"] },
    { label: "Fabricator", to: "fabricator", icon: <Building2 />, roles: ["admin", "sales", "department-manager"] },
    { label: "Project", to: "project", icon: <SquareKanban />, roles: ["admin", "department-manager","project-manager", "client", "user", "estimator", "estimator-head"] },
    ...
    { label: "Estimations", to: "estimation", icon: <ChartCandlestick />, roles: ["admin", "department-manager","user","sales", "estimator-head"] },
    ...
    { label: "Chats", to: "chats", icon: <MessageSquare />, roles: ["admin", "department-manager", "project-manager", "user", "human-resource", "estimator-head"] },
    { label: "Profile", to: "profile", icon: <CgProfile />, roles: ["admin", "user", "client", "estimator", "sales", "project-manager", "department-manager", "human-resource", "estimator-head"] },
  ];
