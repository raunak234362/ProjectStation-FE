...
const EditLineItemModal = ({ item, isOpen, onClose, onSave }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const response = await Service.updateEstimationTaskLineItemsById(lineItemID, responseData);
      toast.success("Line item updated successfully!");
      estimationSignal.value = {...estimationSignal.value, lineItems: estimationSignal.value.lineItems.map(li => li.id === lineItemID ? {...li, ...responseData} : li)};
