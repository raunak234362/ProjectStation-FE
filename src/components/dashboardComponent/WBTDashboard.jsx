...
import { BarChart3, CheckCircle2, Download, LayoutGrid, LineChart, PieChart } from "lucide-react";
                            ...
                            {userType !== "department-manager" && (
                                isLoading ? renderChartSkeleton() : (
                                    <div className="mb-6 bg-white border border-gray-200 rounded-xl shadow-sm">
                                        ...
                                        <div className="p-6">
                                            <div className="w-full" style={{ height: activeChart === "bar" ? `400px` : "400px" }}>
                                                {activeChart === "bar" && (
                                                    <div className="max-h-[400px] overflow-y-auto">
                                                        <div className="min-w-full" style={{ height: `${projectTaskData?.labels?.length * 40}px` }}>
                                                            <Bar
                                                                        ...
                                                                        y: {
                                                                            ...
                                                                            ticks: {
                                                                                callback: function (value) {
                                                                                    ...
                                                                                    const maxLength = window.innerWidth < 500 ? 15 : 25;
