        ...
        <div className="flex flex-col w-screen h-screen overflow-hidden md:flex-row bg-gradient-to-br from-gray-700 to-teal-200">
            <div className="flex flex-col w-full">
                ...
                <div className="flex flex-row">
                    {/* Sidebar */}
                    <div className={`fixed md:static flex flex-col md:bg-opacity-0 bg-white w-64 z-20 transition-transform duration-300 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:translate-x-0 md:w-64`}>
